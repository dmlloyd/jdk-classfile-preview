...
public final class StackMapGenerator {
    ...
    public StackMapGenerator(LabelContext labelContext,
        ...
        this.patchDeadCode = context.deadCodeOption() == DeadCodeOption.PATCH_DEAD_CODE;
        this.filterDeadLabels = context.deadLabelsOption() == DeadLabelsOption.DROP_DEAD_LABELS;

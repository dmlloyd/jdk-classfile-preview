 ...
 * <p>
 * A {@link io.github.dmlloyd.classfile.ClassModel} is an immutable description of a class
 * file.  It provides accessor methods to get at class metadata (e.g., {@link
 * io.github.dmlloyd.classfile.ClassModel#thisClass()}, {@link io.github.dmlloyd.classfile.ClassModel#flags()}),
 * as well as subordinate classfile entities ({@link io.github.dmlloyd.classfile.ClassModel#fields()},
 * {@link io.github.dmlloyd.classfile.ClassModel#attributes()}). A {@link
 * io.github.dmlloyd.classfile.ClassModel} is inflated lazily; most parts of the classfile are
 ...
 * <p>
 * When we enumerate the methods, we get a {@link io.github.dmlloyd.classfile.MethodModel} for each method; like a
 ...
 * <p>
 * Methods like {@link io.github.dmlloyd.classfile.ClassModel#methods} allows us to traverse the class structure
 ...
 * io.github.dmlloyd.classfile.ClassModel} also provides us with a view of the classfile as a
 ...
 * the {@link io.github.dmlloyd.classfile.ClassModel#methods()} accessor) or as a linear
 * sequence of <em>elements</em>. (Elements can in turn also be models; a {@link
 * io.github.dmlloyd.classfile.FieldModel} is also an element of a class.) For each model type
 * (e.g., {@link io.github.dmlloyd.classfile.MethodModel}), there is a corresponding element
 * type ({@link io.github.dmlloyd.classfile.MethodElement}).  Models and elements are immutable
 ...
 * pool</em>. {@link io.github.dmlloyd.classfile.ClassModel} provides a lazily-inflated,
 * read-only view of the constant pool via {@link io.github.dmlloyd.classfile.ClassModel#constantPool()}.
 * Descriptions of classfile content is often exposed in the form of various
 * subtypes of {@link io.github.dmlloyd.classfile.constantpool.PoolEntry}, such as {@link
 * io.github.dmlloyd.classfile.constantpool.ClassEntry} or {@link io.github.dmlloyd.classfile.constantpool.Utf8Entry}.
 * <p>
 * Constant pool entries are also exposed through models and elements; in the
 * above traversal example, the {@link io.github.dmlloyd.classfile.instruction.InvokeInstruction}
 ...
 * io.github.dmlloyd.classfile.attribute.SignatureAttribute} is a {@link
 * io.github.dmlloyd.classfile.ClassElement}, {@link io.github.dmlloyd.classfile.MethodElement}, and {@link
 * io.github.dmlloyd.classfile.FieldElement} since it can appear in all of those places, and is
 ...
 * io.github.dmlloyd.classfile.CodeModel}.)
 * <p>
 ...
 * provides accessors for {@link io.github.dmlloyd.classfile.attribute.SignatureAttribute#signature()}
 * as well as factories taking {@link io.github.dmlloyd.classfile.constantpool.Utf8Entry} or
 * {@link java.lang.String}.
 *
 * <h3>Custom attributes</h3>
 * Attributes are converted between their classfile form and their corresponding
 * object form via an {@link io.github.dmlloyd.classfile.AttributeMapper}.  An {@code
 ...
 * <p>
 * There are built-in attribute mappers (in {@link io.github.dmlloyd.classfile.Attributes}) for
 ...
 * io.github.dmlloyd.classfile.attribute.UnknownAttribute}, which provide access only to the
 ...
 * method {@link io.github.dmlloyd.classfile.constantpool.ClassEntry#asSymbol} returns
 * {@code ClassDesc}.
 * <p>
 ...
 * get an existing {@link io.github.dmlloyd.classfile.ClassModel}, build a new classfile that
 * provides a {@link io.github.dmlloyd.classfile.ClassBuilder}, iterate the elements of the
 * original {@link io.github.dmlloyd.classfile.ClassModel}, and pass through all of them to
 ...
 * io.github.dmlloyd.classfile.CodeElement}:
 ...
 * io.github.dmlloyd.classfile.CodeTransform#andThen(io.github.dmlloyd.classfile.CodeTransform)}:
 *
 * {@snippet lang=java :
 * var cc = ClassFile.of();
 ...
 * io.github.dmlloyd.classfile.constantpool.ClassEntry}.) Factories and builders also
 ...
 * {@link io.github.dmlloyd.classfile.CodeModel} (which models the {@code Code} attribute
 ...
 * }
 *
 * {@link io.github.dmlloyd.classfile.CodeModel} is unique in that its elements are <em>ordered</em>.
